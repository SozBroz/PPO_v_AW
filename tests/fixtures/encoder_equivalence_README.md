...
- `spatial_o0` / `spatial_o1`: shape `(8, 30, 30, N_SPATIAL_CHANNELS)` (70 after defense-star + influence placeholders)
- `scalars_o0` / `scalars_o1`: shape `(8, 17)`
...
7. **s6** — `tier_name="T4"`, non-trivial `power_bar` on both COs, Neo Tank + Rocket.
